...
namespace PiPDisabler
{
    internal static class ScopeLifecycle
    {
        ...
        /// to match the new zoom level without waiting for the next OnAimOrPoseChanged call.
        ...
        private static void RestoreFov()
        {
            try
            {
                ...
                if (targetFov > 30f)
                {
                    ...
                    // concurrent OnAimOrPoseChanged tick in the same frame is already blocked.
